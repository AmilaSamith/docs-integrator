...
2. Add the header, body, and envelope records in [Types](../integration-artifacts/supportive-artifacts/types.md).
3. Open the flow and [add a step](../../editor/canvases/flow-canvas/flow-canvas.md#anatomy-of-the-canvas).
