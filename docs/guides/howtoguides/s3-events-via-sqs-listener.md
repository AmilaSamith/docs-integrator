...
- **Deploy the integration** — ship to [WSO2 Cloud](../../deploy/cloud/overview.md), a [Docker container](../../deploy/containerized-deployment.md#docker-deployment), or [Kubernetes](../../deploy/containerized-deployment.md#kubernetes-deployment) for production use.
