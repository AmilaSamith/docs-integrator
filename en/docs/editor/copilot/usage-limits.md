...
sidebar_position: 6
title: "Usage Limits"
description: "See how much of your WSO2 Integrator Copilot usage remains, what happens when you reach the limit, and how to ask for more."
keywords: [wso2 integrator, copilot, usage, usage limit, quota, fair usage]
slug: /editor/copilot/usage-limits
---
...
![The usage indicator in the Copilot panel header.](/img/editor/copilot/usage-badge.png)
...
![The usage limit message above the Copilot chat box.](/img/editor/copilot/usage-limit-notice.png)
...
![The Request additional quota form.](/img/editor/copilot/quota-request-form.png)
...
![The message confirming that a request has been submitted.](/img/editor/copilot/quota-request-submitted.png)
