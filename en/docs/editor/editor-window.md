...
sidebar_position: 0
title: Editor Window
description: The shared window that surrounds every view in the WSO2 Integrator editor.
keywords: [wso2 integrator, editor window, activity bar, editor toolbar, status bar]
