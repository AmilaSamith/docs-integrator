...
For end-to-end usage, including how to create a GraphQL service from scratch or import an existing schema, see [GraphQL Service](../../develop/integration-artifacts/service/graphql.md).
...
To create a new GraphQL service before opening the editor, see [GraphQL Service](../../develop/integration-artifacts/service/graphql.md).
...
- [GraphQL Service](../../develop/integration-artifacts/service/graphql.md): end-to-end guide to creating and configuring a GraphQL service.
