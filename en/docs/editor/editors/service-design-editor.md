...
The Service Design editor, also known as the **service designer**, is the editor you open for any service entry point in WSO2 Integrator. It lists every resource or handler the service exposes and gives you one place to add, edit, remove, try out, and export them.
...
To create a new service before opening the editor, see [Integration artifacts](../../develop/integration-artifacts/integration-artifacts.md) and choose the service type ([HTTP](../../develop/integration-artifacts/service/http.md), [gRPC](../../develop/integration-artifacts/service/grpc.md), [TCP](../../develop/integration-artifacts/service/tcp.md), [WebSocket](../../develop/integration-artifacts/service/websocket.md), [WebSub Hub](../../develop/integration-artifacts/service/websub-hub.md)).
...
- [Integration artifacts](../../develop/integration-artifacts/integration-artifacts.md): browse the full set of services, automations, event handlers, and file processors you can build.
