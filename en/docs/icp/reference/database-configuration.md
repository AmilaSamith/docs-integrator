...
- The schema user needs `CREATE SESSION`, `CREATE TABLE`, `CREATE VIEW`, `CREATE TRIGGER`, `CREATE SEQUENCE`, and a tablespace quota. See [Install ICP](../install-icp.md#database).
