...
description: Learn how to enable and configure API rate limiting in WSO2 Cloud - Integration Platform.
keywords: [api rate limiting, rate limiting, request limit, api performance, throttling]
