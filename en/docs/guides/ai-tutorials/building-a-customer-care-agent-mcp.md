...
For more detail on using the chat panel, see [Try-It experiences](../../test/built-in-try-it-tool.md#try-it-experiences).
...
- [Exposing a service as an MCP server](../../develop/ai/mcp/exposing-as-mcp.md) — Build your own MCP server like the one used in this tutorial
- [Consuming MCP from an agent](../../develop/ai/mcp/consuming-mcp-from-agent.md) — Deeper reference for `ai:McpToolKit` options
- [Adding memory to an agent](../../develop/ai/agents/memory.md) — Persist conversation history across sessions
- [AI agent observability](../../develop/ai/agents/observability.md) — Trace tool calls and monitor agent performance
