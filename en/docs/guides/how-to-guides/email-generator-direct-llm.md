...
card_keywords: [content generation, prompt, quick start]
---

# Email Generator with Direct LLM

This tutorial walks through building an **HTTP service that generates professional emails using an LLM**. It's a complete, end-to-end scenario that exercises the [Direct LLM Calls](../../develop-and-test/integration-artifacts/ai-integrations/direct-llm/direct-llm.md) feature surface.
...
2. **Add a [model provider](../../develop-and-test/integration-artifacts/ai-integrations/ai-building-blocks/model-providers.md)** as the connection to the LLM.
...
![Artifacts page with HTTP Service highlighted under Integration as API.](/img/genai/develop-and-test/direct-llm/01-artifacts-page.png)
...
![Create HTTP Service form with Service Base Path set to /api/v1.](/img/genai/develop-and-test/direct-llm/02-create-http-service.png)
...
![Define Payload dialog with sample JSON and type name EmailGeneratePayload.](/img/genai/develop-and-test/direct-llm/03-define-payload.png)
...
![Create New Type dialog with EmailGenerateResponse and sample JSON.](/img/genai/develop-and-test/direct-llm/04-define-response-type.png)
...
![Completed resource configuration with both types assigned.](/img/genai/develop-and-test/direct-llm/05-resource-complete.png)
...
![Model Provider list showing all supported providers.](/img/genai/develop-and-test/direct-llm/06-model-provider-list.png)
...
![Model Provider configuration with name emailGenerator.](/img/genai/develop-and-test/direct-llm/07-model-provider-config.png)
...
![emailGenerator expanded with Chat and Generate actions.](/img/genai/develop-and-test/direct-llm/08-generate-action.png)
...
![Prompt editor with the email writing assistant instruction.](/img/genai/develop-and-test/direct-llm/09-prompt-editor.png)
...
![emailGenerator > generate form with prompt, Result generatedEmail, and Expected Type EmailGenerateResponse.](/img/genai/develop-and-test/direct-llm/10-generate-config.png)
...
![Add Node panel showing Connections, Statement, Control, and AI categories.](/img/genai/develop-and-test/direct-llm/11-add-node-panel.png)
...
![Completed flow with ai:generate connected to emailGenerator and a Return node.](/img/genai/develop-and-test/direct-llm/12-flow-complete.png)
...
![Try Service panel showing POST /emails/generate with request body schema.](/img/genai/develop-and-test/direct-llm/13-try-service.png)
...
![Response showing 201 Created with the generated email subject and content.](/img/genai/develop-and-test/direct-llm/14-response.png)
