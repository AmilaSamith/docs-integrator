...
description: Create and deploy an integration directly in the browser using the WSO2 Cloud editor, without installing the WSO2 Integrator editor locally.
keywords: [wso2 integrator, wso2 cloud, cloud editor, deploy, browser, development environment]
slug: /deploy-and-run/deploy-to-wso2-cloud/deploy-from-cloud-editor
---
...
Develop your integration in the cloud editor as you would in the WSO2 Integrator editor. You can add artifacts, configure connections, define data mappers, and more.
