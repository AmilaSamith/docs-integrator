...
sidebar_position: 2
title: "Metrics"
description: "Monitor request throughput, latency, and resource usage for integrations deployed on WSO2 Cloud - Integration Platform."
keywords: [wso2 integrator, wso2 cloud, metrics, observability, monitoring]
...
Clicking a point on a graph filters the **Logs** pane to show log entries from that time, making it easier to correlate anomalies with specific events in your integration.
