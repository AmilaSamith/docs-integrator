---
sidebar_position: 6
sidebar_custom_props: { "separatorBefore": "Library" }
title: Create a Library
description: Create reusable library packages for sharing common logic across integrations.
slug: /develop-and-test/organize-workbench/create-a-library
---
...
WSO2 Integrator generates the library project and opens the [library view](../../editor/views/library-view.md). The file structure for a library within a project contains a root `Ballerina.toml` and a subdirectory for the library package:
...
- [Library view](../../editor/views/library-view.md) — Learn how to manage and configure your library project
