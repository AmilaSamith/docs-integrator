...
slug: /develop-and-test/organize-workbench/open-existing-integration
---
...
- **A project folder** — A directory that contains a root `Ballerina.toml` and one or more integration or library subdirectories. WSO2 Integrator opens the [project view](../../editor/views/project-view.md).
- **An integration or library folder** — A single package directory that contains a `Ballerina.toml` and `.bal` source files. WSO2 Integrator opens the [integration view](../../editor/views/integration-view.md) or [library view](../../editor/views/library-view.md) depending on the package type.
