...
slug: /develop-and-test/developer-tools/integration-tools/asyncapi-tool
---
...
- [Error Handling](../../../editor/canvases/flow-canvas/node-palette.md#error-handling) -- Handle event processing failures gracefully
