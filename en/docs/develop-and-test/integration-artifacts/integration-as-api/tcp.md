...
slug: /develop-and-test/integration-artifacts/integration-as-api/tcp
---
...
- [Connections](../supportive-artifacts/connections.md) — configure TCP client connections to call external services
