...
slug: /develop-and-test/integration-artifacts/workflow/durable-workflow/await-human-task
---
...
That record produces a two-field form in the inbox, and the workflow resumes with those values as an ordinary typed record. Records created this way are ordinary types, editable later from **Types** in the sidebar. See [Types](../../supportive-artifacts/types.md) for the type editor and the kinds it supports.
