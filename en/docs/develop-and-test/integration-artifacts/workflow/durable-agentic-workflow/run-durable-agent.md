...
slug: /develop-and-test/integration-artifacts/workflow/durable-agentic-workflow/run-durable-agent
---
...
<ThemedImage
    alt="The claim resource flowing from Start into the claimAgent node labeled instanceId, with the ReviewDocuments human task and the chat data event on the left, the gated payClaim activity on the right, and the Error Handler below"
    sources={{
...
- [Workflow executions](../../../../integrator/icp/icp-console-overview.md) — watching the started instance and deciding what it escalates.
- [Build a Claim Handling Durable Agent](../../../../get-started/quickstarts/build-claim-handling-agent.md) — the same agent driven end to end.
