...
slug: /develop-and-test/integration-artifacts/event-driven-integration/mqtt
---
...
- [Connections](../supportive-artifacts/connections.md) — reuse MQTT connection credentials across services
