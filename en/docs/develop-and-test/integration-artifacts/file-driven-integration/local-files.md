...
slug: /develop-and-test/integration-artifacts/file-driven-integration/local-files
---
...
- [Connections](../supportive-artifacts/connections.md) — reuse connection credentials across services
