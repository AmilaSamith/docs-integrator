...
- **[VM Deployment](vm-deployment.md)** — Deploy your integration to a virtual machine or bare-metal server as a standalone JAR file.
- **[Containerized Deployment](containerized-deployment.md)** — Package your integration as a container and deploy it to Docker, Kubernetes, or Red Hat OpenShift.
