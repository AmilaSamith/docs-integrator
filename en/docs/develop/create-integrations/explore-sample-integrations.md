...
Select a folder and click **Select Folder**. WSO2 Integrator downloads the sample and opens it as a project. From there, you can explore the code, run, edit, and debug the integration using the [project views](../../editor/views/project-view.md).
