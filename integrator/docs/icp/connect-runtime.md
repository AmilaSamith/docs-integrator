...
This guide covers manual configuration. If you are developing in the WSO2 Integrator IDE, the setup is automated. See [Integration Control Plane (ICP)](index.md).
