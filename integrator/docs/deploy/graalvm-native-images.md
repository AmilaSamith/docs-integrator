...
- [VM Deployment](vm-deployment.md) -- Run native binaries on virtual machines
- [Containerized Deployment](containerized-deployment.md) -- Build minimal container images for Docker, Kubernetes, and OpenShift
