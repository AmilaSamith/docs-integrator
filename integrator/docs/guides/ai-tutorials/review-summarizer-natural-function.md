...
This tutorial walks through building an **HTTP service that uses a Natural Function to analyze a customer review** and return structured feedback. It is the end-to-end scenario for the [Natural Functions](../../develop/ai/natural-functions/overview.md) feature.
...
- **[Natural Functions reference](../../develop/ai/natural-functions/overview.md)** — the single-page reference covering the form, the Prompt node, typed return inference, and calling from a flow.
